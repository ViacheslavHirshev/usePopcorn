    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {
            !isLoading && !error && <Movies movies={movies} onSelectMovie={selectMovie} />
          }
          {
            ...
            selectedId
              ...
              : (
                <>
                  ...
                  <WatchedMovies watched={watched} onWatchedMovieDelete={deleteWatchedMovie} />
                </>
              )
          }
        </Box>
...
function SearchBar({ query, setQuery }: { query: string, setQuery: React.Dispatch<SetStateAction<string>> })
{
  return (
    <input
      className="search"
